...
if (False): #load
    policy_net.load_state_dict(torch.load(param_file))
    target_net.load_state_dict(policy_net.state_dict())
    target_net.eval()
...
while steps_done < MAX_TIMESTEPS:
    ...
    if steps_done % 1000 == 0: # Save image of training every 1000 episodes
        ...
        plt.xlabel("Steps")
        plt.ylabel("Return")
        plt.savefig('figures/1elevator_'+str(steps_done)+'return.png')
        plt.figure()
        plt.plot(reward_at_step)
        plt.plot(moving_average(reward_at_step))
        plt.xlabel("Steps")
        plt.ylabel("Reward")
        plt.savefig('figures/1elevator_'+str(steps_done)+'reward.png')
        plt.figure()
        plt.plot(action_taken)
        plt.plot(moving_average(action_taken))
        plt.xlabel("Steps")
        plt.ylabel("Action Taken")
        plt.savefig('figures/1elevator_'+str(steps_done)+'action.png')
        plt.figure()
        plt.plot(loss_at_step)
        plt.plot(moving_average(loss_at_step))
        plt.xlabel("Steps")
        plt.ylabel("Loss")
        plt.savefig('figures/1elevator_'+str(steps_done)+'loss.png')
        plt.close('all')
        save(target_net, param_file)
...
plt.xlabel("Steps")
plt.ylabel("Return")
plt.savefig('1elevator_return.png')
plt.figure()
plt.plot(reward_at_step)
plt.plot(moving_average(reward_at_step))
plt.xlabel("Steps")
plt.ylabel("Reward")
plt.savefig('1elevator_'+str(steps_done)+'reward.png')
plt.figure()
plt.plot(action_taken)
plt.plot(moving_average(action_taken))
plt.xlabel("Steps")
plt.ylabel("Action Taken")
plt.savefig('1elevator_'+str(steps_done)+'action.png')
plt.figure()
plt.plot(loss_at_step)
plt.plot(moving_average(loss_at_step))
plt.xlabel("Steps")
plt.ylabel("Loss")
plt.savefig('1elevator_'+str(steps_done)+'loss.png')
plt.close('all')
