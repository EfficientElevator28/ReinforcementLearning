...
n_floors = 20
state_size = n_floors*4 + n_floors*2 + 1 #I determined this empirically. It's probably bad
poisson_density = .05
...
class Simulation_for_RL:
    def __init__(self, n_floors):
        self.sim = Simulator('RL_V1', step_func=realistic_physics_step_func, reward_func=reward_log_sum_wait_time,
    ...
    def step(self, action):
        ...
        return np.concatenate((states,one_hot_location_state,waiting_states)), reward - same*200 #state, reward
...
folder = 'figures_wait_time_state'
...
class DQN(nn.Module):
    def __init__(self, n_actions, input_size):
        ...
        self.output = nn.Linear(self.hidden4Size, self.outputSize)
    # ===============================================   
    def forward(self, x):
        """
